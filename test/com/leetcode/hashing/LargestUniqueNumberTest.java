...
class LargestUniqueNumberTest {
    ...
    @Test
    void largestUniqueNumber() {
        int nums[] = {5, 7, 3, 9, 9, 7, 8, 1};
        LargestUniqueNumber largestUniqueNumber = new LargestUniqueNumber();
        int largest = largestUniqueNumber.largestUniqueNumber(nums);
        assertEquals(8, largest);
    }

    @Test
    void largestUniqueNumber_2() {
        int nums[] = {9, 9, 8, 8};
        LargestUniqueNumber largestUniqueNumber = new LargestUniqueNumber();
        int largest = largestUniqueNumber.largestUniqueNumber(nums);
